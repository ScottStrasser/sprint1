...
{
	$sanInput = filter_var($_POST['searchinput'],FILTER_SANITIZE_STRING);

	$valInput = filter_var($sanInput,FILTER_VALIDATE_STRING);
...
if($goAhead == true)
{
	...
	$query = "SELECT * FROM bookinfo WHERE isbn = {$sanInput}, booktitle = {$sanInput}, author = {$sanInput}";
